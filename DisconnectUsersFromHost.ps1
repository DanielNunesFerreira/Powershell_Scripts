# Run this script on Terminal Server
# If you want to only disconnect who has been idling for 1day/1hour, uncomment below.
# If you leave it the way it is, it will instantly log-off users that have the state "Disconnected"
